...
def extracter(email_message):
    ...
    return [date_of_payment, amount, receiver, time_of_payment]
...
def write_to_sheets(data, sheet_id, range_name):
...
Date: Thu, 27 Jun, 2024, 7:58 am
Subject: ❗ You have done a UPI txn. Check details!
To: <NAYANRSR@gmail.com>

Dear Customer,

Rs.452.48 has been debited from account **1021 to VPA bookmyshow@axb on 27-06-24. Your UPI transaction reference number is 417943567179.
...
extracted_data = extracter(email_message)

# Replace with your Google Sheet ID and range name
sheet_id = '14dQU7jV2OqV5ZEVJuwpgPZwgP37IVtrZr-URxkjvXOU'
range_name = 'Sheet1'
...
write_to_sheets(data_to_write, sheet_id, range_name)
